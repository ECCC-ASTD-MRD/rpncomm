...
! */
      ...
      SUBROUTINE RPN_COMM_transpose48(za,min1,max1,n1g,min2,max2,n2l,min3,max3,n3g,zb_8,type,a_8,b_8)
      use rpn_comm
      implicit none
...
!	  call tmg_start(96,'RPN_COMM_Xpose1')
        call RPN_COMM_Xpose148(npe,pecomm,za,min1,max1,n1g,min2,max2,n2l,min3,max3,n3g,zb_8,a_8,b_8)
!	  call tmg_stop(96)
!
      else ! backward transpose
!
!	  call tmg_start(98,'RPN_COMM_Xpose248')
        call RPN_COMM_Xpose248(npe,pecomm,za,min1,max1,n1g,min2,max2,n2l,min3,max3,n3g,zb_8,a_8,b_8)
!	  call tmg_stop(98)
!
      endif
!
